...
matches_standard_cols_rename = ['Goals', 'Assists', 'Pens Made', 'Pens Att', 'Shots', 'Shots on Target', 'Yellow Cards', 'Red Cards', 'Touches', 'Tackles', 'Interceptions', 'Blocks', 'xG', 'npxG', 'xA', 'SCA', 'GCA', 'Passes Completed', 'Passes', 'Passes %', 'Prog Passes', 'Carries', 'Prog Carries', 'Take Ons', 'Take Ons Won']
...
matches_passing_cols_rename = ['Pass Dist', 'Prog Pass Dist', 'Passes Cmp Short', 'Passes Short', 'Passes % Short', 'Passes Cmp Medium', 'Passes Medium', 'Passes % Medium', 'Passes Cmp Long', 'Passes Long', 'Passes % Long', 'Pass xA', 'Key Passes', 'Passes into Final Third', 'Passes into Penalty Area', 'Crosses into Penalty Area']
...
matches_pass_types_rename = ['Passes Live', 'Passes Dead', 'Freekicks', 'Through Balls', 'Passes Switches', 'Crosses', 'Throw Ins', 'CKs', 'CKs (inswinging)', 'CKs (outswinging)', 'CKs (straight)', 'Passes Offsides', 'Passes Blocked']
...
matches_defense_cols_rename = ['Tackles Won', 'Tackles Def 3rd', 'Tackles Mid 3rd', 'Tackles Att 3rd', 'Challenge Tackles', 'Challenges', 'Challenge Tackles %', 'Challenges Lost', 'Blocked Shots', 'Blocked Passes', 'Tackles + Int', 'Clearances', 'Errors', 'Touches Def Pen Area', 'Touches Def 3rd', 'Touches Mid 3rd', 'Touches Att 3rd', 'Touches Att Pen Area', 'Touches Live Ball', 'Take Ons Won %', 'Take Ons Tackled', 'Take Ons Tackled %']
...
matches_possession_cols_rename = ['Carries Dist', 'Prog Carries Dist', 'Carries into Final Third', 'Carries into Penalty Area', 'Miscontrols', 'Dispossessed', 'Passes Received', 'Prog Passes Received']
...
matches_misc_cols_rename = ['Double Yellows', 'Fouls', 'Fouled', 'Offsides', 'Pens Won', 'Pens Conceded', 'Own Goals', 'Ball Recoveries', 'Aerials Won', 'Aerials Lost', 'Aerials Won %']
