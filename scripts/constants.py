...
matches_default_cols = ['player', 'Pos', 'GW', 'started', 'Team']
...
matches_data = '/Users/hogan/dev/streamlit_proj_new/data/data_out/scraped_big5_data/pl_data/full_season_matchreports_20230826.csv'
