...
def create_sidebar_multiselect(df, column_name, title='Select Options', default_all=True, key=None):
    ...
    selected_options = st.sidebar.multiselect(title, options, default=default_options, key=key)
