...
pl_data_gw1 = 'data/data_out/scraped_big5_data/pl_data/big5_player_table_gw1.csv'
...
matches_shots_data = 'data/data_out/scraped_big5_data/pl_data/all_shots_all_20230820.csv' 
matches_all_data = 'data/data_out/scraped_big5_data/pl_data/full_season_matchreports_20230820.csv'
